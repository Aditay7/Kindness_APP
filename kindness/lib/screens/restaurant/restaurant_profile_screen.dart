      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: ResponsiveHelper.getHeight(context) * 0.02),
            _buildInfoRow(Icons.badge, 'Tax ID: ${restaurant.taxId}', context),
            _buildInfoRow(Icons.email, restaurant.email, context),
            _buildInfoRow(Icons.phone, restaurant.phone, context),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: ResponsiveHelper.getHeight(context) * 0.02),
            Text(
              _formatAddress(restaurant.address),
              style: TextStyle(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: ResponsiveHelper.getHeight(context) * 0.02),
            Text(
              _formatAddress(restaurant.serviceArea),
              style: TextStyle(
                fontSize: ResponsiveHelper.getFontSize(context, 16),
              ),
            ),
            if (restaurant.serviceArea['radius'] != null) ...[
              SizedBox(height: ResponsiveHelper.getHeight(context) * 0.01),
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: ResponsiveHelper.getWidth(context) * 0.01),
                    Text(
                      'Service Radius: ${restaurant.serviceArea['radius']} km',
                      style: TextStyle(
